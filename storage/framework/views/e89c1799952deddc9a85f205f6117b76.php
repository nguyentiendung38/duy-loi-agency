...
<head>
    ...
    <title>Khóa Học Facebook Ads</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="course-header">
            <img src="/dist/images/page/hanhnghe.jpg" alt="Khóa Học Facebook ADS Freelancer">
            <h2>Truyền Nghề Facebook ADS Freelancer 102</h2>
            <div class="features">
                <span><i class="fas fa-video"></i> Video/Text</span>
                <span><i class="fab fa-facebook"></i> Quảng Cáo Facebook</span>
                <span><i class="fas fa-book"></i> 101 Bài Học</span>
        ...
        <div class="course-content">
            ...
            <ul>
                ...
                <li>Template</li>
                <li>Coaching 1:1 quảng cáo Facebook cho người mới</li>
                <li>Support khóa học</li>
            </ul>
        </div>
        <a href="<?php echo e(url('/payment/facebook')); ?>" class="btn-purchase">Mua Ngay!</a>
    </div>
</body>
...
</html><?php /**PATH C:\laragon\www\TrickerChannel\resources\views/khoa-hoc-facebook.blade.php ENDPATH**/ ?>