            ...
            <nav id="mobile-menu">
                <ul>
                    ...
                    <li class="has-submenu">
                        <a href="#">DỊCH VỤ</a>
                        <ul class="submenu">
                            <li><a href="<?php echo e(route('services.facebook-ads')); ?>">FACEBOOK ADS</a></li>
                            <li><a href="<?php echo e(route('services.tiktok-ads')); ?>">TIKTOK ADS</a></li>
                            <li><a href="<?php echo e(route('services.instagram-ads')); ?>">INSTAGRAM ADS</a></li>
                        </ul>
                    </li>
...
</html><?php /**PATH C:\laragon\www\TrickerChannel\resources\views/partials/menu.blade.php ENDPATH**/ ?>