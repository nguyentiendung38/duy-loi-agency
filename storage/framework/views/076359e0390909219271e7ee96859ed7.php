<?php $__env->startSection('title', 'Tư Vấn Chuyên Nghiệp'); ?>
<?php $__env->startSection('content'); ?>
<?php echo $__env->make('partials.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<div class="container-fluid p-0">
    <!-- Banner Section -->
    <div class="banner">
        <img src="<?php echo e(asset('dist/images/page/tuvan.jpg')); ?>" alt="Banner Tư Vấn Chuyên Nghiệp" class="hero-image img-fluid w-100" style="object-fit: contain;">
    </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\TrickerChannel\resources\views/services/tu-van-chuyen-nghiep.blade.php ENDPATH**/ ?>