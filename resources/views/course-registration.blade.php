    ...
    <div class="container">
        ...
        <div class="course-container">
            <div class="course-card">
                ...
                <a href="{{ url('/khoa-hoc-facebook') }}" class="btn btn-dark">Mua Ngay</a>
            </div>
            ...
            <div class="course-card">
                ...
                <p><strong>Chưa bắt đầu</strong></p>
                <a href="{{ url('/khoa-hoc-tiktok') }}" class="btn btn-dark">Mua Ngay</a>
            </div>
            ...
            <div class="course-card">
                ...
                <p><strong>Chưa bắt đầu</strong></p>
                <a href="{{ url('/khoa-hoc-instagram') }}" class="btn btn-dark">Mua Ngay</a>
            </div>
